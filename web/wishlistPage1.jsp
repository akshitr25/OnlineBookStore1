					...
					<div class="span9">
						...
						<div class="row">
							...
							<div class="span9">	
								...
								<h4 class="title">
                                                                    <%
                                                                        PreparedStatement psnum=con.prepareStatement("select count(bookid) from wishlist where username=?;");
                                                                                psnum.setString(1,uname_var);
                                                                                ResultSet rsnum=psnum.executeQuery();
                                                                                rsnum.next();
                                                                                int total_books=rsnum.getInt(1);
                                                                                double total_slides=(total_books/3);//check
                                                                                int rem=total_books%3;
                                                                                if(rem>0)
                                                                                    total_slides++;
                                                                    %>
                                                                    <span class="pull-left"><span class="text">You have <strong><%=total_books%></strong> books in your wishlist.</span></span>
								...
								<div id="myCarousel-1" class="carousel slide">
									<div class="carousel-inner">
                                                                            <%
                                                                                ...
                                                                                PreparedStatement ps0=con.prepareStatement("select bookid,bookname from wishlist where username=?;");
											...
											<ul class="thumbnails listing-products">
                                                                                            <%
                                                                                                for(int x=1;x<=3;x++)
                                                                                                {
                                                                                                    if(rs0.next())
                                                                                                    {
                                                                                                    int bookid_var=rs0.getInt(1);
                                                                                                    String bookname_var=rs0.getString(2);
                                                                                                    String img_path="images/"+bookid_var+".jpg";//bookid_var+".jpg";
                                                                                                    PreparedStatement ps1=con.prepareStatement("select author,price from books where bookid=?;");
                                                                                                    ps1.setInt(1,bookid_var);
                                                                                                    ResultSet rs1=ps1.executeQuery();
                                                                                                    rs1.next();
                                                                                                    String author_var=rs1.getString(1);
                                                                                                    int price_var=rs1.getInt(2);
                                                                                            %>
												<li class="span3">
